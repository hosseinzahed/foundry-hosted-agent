# Connect researcher-agent to Microsoft Teams

`azd deploy` already did the Azure side for you:

- Azure Bot: `researcher-agent00538` (Microsoft Teams channel enabled)
- Bot ID (msaAppId): `34c4ce44-f5a4-418a-9244-4092a457671a`
